...
### Downsize all the data to top 10% variance
...
```{r cna_downsize}
cna.var <- apply(cna.BRCA$dat, 1, var)
cna.data.BRCA <- subset(cna.BRCA$dat, cna.var >= quantile(cna.var, 0.99, na.rm=T) & !is.na(cna.var))
```
