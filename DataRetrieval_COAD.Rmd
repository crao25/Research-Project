...
string1 <- substring(string1, 1, 12)
string2 <- colnames(meth.COAD$dat)
string2 <- substring(string2, 1, 12)
string3 <- colnames(mut.COAD$dat)
string3 <- substring(string3, 1, 12)
string4 <- colnames(cna_COAD$dat)
string4 <- substring(string4, 1, 12)
...
rnaseq_data <- data.matrix(head(rnaseq.COAD$dat))
meth_data <- data.matrix(head(meth.COAD$dat))
mut_dat <- data.matrix(head(mut.COAD$dat))
cna.data <- data.matrix(head(cna_COAD$dat))
