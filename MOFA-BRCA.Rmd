...
This step is repeated here, despite being included in the data retrieval code. This is because, one can make changes in the preprocessing steps without going back to the data retrieval code and performing the retriavl process again (which takes a long time to finish).
